...
const ParallaxPage4Form = ({ parallax, steps, setSteps }: ParallaxProps) => {
    ...
    const addRow = (type: string) => {
        setsubscriptions((oldsubscriptions: any[]) => {
            return [...oldsubscriptions, { name: '', price: '', frequency: '', type: '' }]
        })
    }
    const onSubmit = () => {
...
export default ParallaxPage4Form